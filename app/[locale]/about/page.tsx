...
const About: FC = () => {
  ...
  useEffect(() => {
    const load = async () => {
      const data = (await import(`app/[locale]/blog/blogs/${locale}`)).serviceBlogs.filter((blog) => {
        ...
        <section className="my-16">
          ...
          <div className="my-8">
            <Row gutter={[24, 24]} justify="center">
              {profiles?.[`${locale}`]?.map((profile: any) => {
                return (
        ...
        <section className="pb-16 pt-2">
          <div id="video" ref={ref} style={{ height: height, width: "100%" }}>
            <iframe
              width="100%"
              height="100%"
              src="https://www.youtube.com/embed/jy1Q-VlgNdA?si=mSX6LkQBejhZPm8A&mute=1&loop=1&autoplay=1&amp;controls=0&amp;rel=0&amp;disablekb=0&amp;modestbranding=1&amp;showinfo=0&amp;preload=true&amp;playsinline=1&amp;iv_load_policy=3&amp;enablejsapi=1&amp;origin=http%3A%2F%2Fcaztus.vn&amp;widgetid=1"
